...
include "session.php";
$stmt = "select * from trader where TID='$ifak'";
...
if(isset($_POST['login2']))
{
   ...
   trader
   set 
   FIRSTNAME='$firstname',LASTNAME='$lastname',PHNUMBER='$phone',COUNTRY='$country',STATE='$state',CITY='$city',ZIP='$zip' 
   where TID='$ifak' ";
   ...
   {
       echo "you updated";
       mail($mail,"update","your creditiaonal have been update");
