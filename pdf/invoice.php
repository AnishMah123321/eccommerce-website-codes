...
$message = '';
$connect = new PDO("oci:host=//localhost/xe;dbname=ADMIN", "ADMIN", "root");
//$connect=mysqli_connect('//localhost/xe','ADMIN','raghu');
//mysqli_select_db($con,'hash');
//$user='ADMIN';
//$pass='raghu';
//$conn_string = '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=8080))(CONNECT_DATA=(SERVICE_NAME=XE)))';
//$connnect = new PDO('oci:dbname=' . $conn_string, $user, $pass);

//$connect = new PDO('oci:host=localhost/XE; dbname= ADMIN', 'ADMIN','raghu');
//$connect = new PDO("oci:host=//localhost/xe;dbname=ADMIN", "ADMIN", "raghu");

//$conn_string = '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=8080))(CONNECT_DATA=(SERVER = DEDICATED)(SERVICE_NAME=xe)))';
//$connect = new PDO('oci:dbname=' . $conn_string, $user, $pass);
